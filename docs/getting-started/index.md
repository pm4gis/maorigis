...
title: Tools
---
This page is a practical overview of common GIS tools used The aim is to help you choose tools that fit your kaupapa, your people, your budget, your IT constraints, and the level of care required for the data.

## Most teams use a series of tools, not just one tool
...
- ArcGIS Pro when you need compatibility with councils and Crown partners or are an advanced user.
- ArcGIS Online for sharing web maps, apps, and dashboards, collective editing, and connected applications
- StoryMaps for narrative outputs or sharing stories.
- Field Maps, Survey123, or KoboToolbox for field data capture using mobiles
- Google Earth Pro for quick kōrero and visualisation in 3D
